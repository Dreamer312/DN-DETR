...
from cmh_dn_vg_engine import evaluate, train_one_epoch
...
def get_args_parser():
    ...
    parser.add_argument('--dataset_file', default='vg')
...
def main(args):
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(
            ...
            args.clip_max_norm, wo_class_error=wo_class_error, lr_scheduler=lr_scheduler, args=args, logger=(logger if args.save_log else None), wandb_logger = wandb)
        if args.output_dir:
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('DN DETR training and evaluation script', parents=[get_args_parser()])
